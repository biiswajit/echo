...
import { Button, Google, Github } from "@echo/ui";
import { signin } from "@/lib/actions";
import { useState } from "react";

export function RegisterForm(): JSX.Element {
  const [authMethod, setAuthMethod] = useState<"google" | "github" | null>();
  ...
  return (
    ...
    <p className="text-sm text-black-0 text-center mt-4 font-default">
      ...
      <a href="" className="font-semibold underline underline-offset-4">Terms of Service</a>
        {" "}and{" "}
      <a href="" className="font-semibold underline underline-offset-4">Privacy Policy</a>
    </p>
  </div>);
}